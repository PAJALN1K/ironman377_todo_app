...
fn main() {
    ...
    'main_loop: loop {
        ...
        println!("2. Удалить задачу (на фронтенде реализовано).");
        println!("3. Переименовать задачу.");
        println!("4. Обозначить задачу, как выполненную (на фронтенде реализовано).");
        println!("5. Обозначить задачу, как еще не выполненную (на фронтенде реализовано).");
        ...
        println!("9. Отобразить все задачи (на фронтенде реализовано).");
